  ...
  <b-form @submit.prevent="validateInputForm">
    ...
    <div class="form-group row">
      <div class="col-xs-6 col-md-6">
        ...
        <b-form-input placeholder="Icon"
                      v-model.trim="ninjaFormInput.image"/>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <tag-manipulator class="col-xs-6 col-md-6" :type="TAG.TALENT"
                       ...
                       :available="availableOptions(TAG.TALENT,ninjaFormInput.tags[TAG.TALENT])"
    ...
    <tag-manipulator :type="TAG.CROWD_CONTROL"
                     ...
                     :available="availableOptions(TAG.CROWD_CONTROL,ninjaFormInput.tags[TAG.CROWD_CONTROL])"
                     v-on:addTagToDescription="addTagToDescription"
                     v-on:removeSelectedOption="removeSelectedOption"/>
    <tag-manipulator class="mt-2" :type="TAG.IMMUNITY"
                     :selected="ninjaFormInput.tags[TAG.IMMUNITY]"
                     :available="availableOptions(TAG.IMMUNITY,ninjaFormInput.tags[TAG.IMMUNITY])"
                     v-on:addTagToDescription="addTagToDescription"
                     v-on:removeSelectedOption="removeSelectedOption"/>
...
export default {
  ...
  methods: {
    validateInputForm: function () {
      this.$emit("saveInputForm", {actionType: this.actionType, data: this.ninjaFormInput})
    ...
    removeSelectedOption: function (type, value) {
      this.ninjaFormInput.tags[type] = this.ninjaFormInput.tags[type].filter((tag) => tag !== value)
    },
    resetInputForm() {
      this.ninjaFormInput = {
        name: '',

<template>
  <b-tabs>
    <b-tab
      v-for="tagType in allTags"
      :key="tagType.label"
      :title="tagType.text"
    >
      <b-form class="col-md-4">
        <b-tag
          v-for="tagValue in tagType.options"
        ...
        <b-input-group class="mt-4">
          <b-input-group-prepend>
            <b-button variant="outline-secondary" @click="addNewTag(tagType.id)"
              >Add</b-button
            >
          </b-input-group-prepend>
          <b-form-input v-model="newTag" placeholder="Type new tag here" />
        </b-input-group>
      </b-form>
    </b-tab>
  </b-tabs>
